...
export default function Hero() {
  ...
  return (
    ...
    <div className="flex lg:h-[100dvh]">
        ...
        <img src={arrow} onClick={handleScroll} className="lg:block absolute bottom-2 size-16 lg:size-20 left-[10rem] lg:left-[47%] cursor-pointer animate-bounce" alt="arrow-down" />
    </div>
    <Feed/>
    </>
  )
